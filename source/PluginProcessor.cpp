    ...
    : AudioProcessor (BusesProperties()
      ...
      mProcessorValueTreeState (
          *this,
          ...
          {
              make_unique<AudioParameterFloat> (ParameterID (inputGainParameterId, 0), inputGainParameterName, gainMinimumValue, gainMaximumValue, gainDefaultValue),
              ...
              make_unique<AudioParameterBool> (ParameterID (overdriveTanhWaveShaperBypassParameterId, 2), overdriveTanhWaveShaperBypassParameterName, false),
              make_unique<AudioParameterBool> (ParameterID (overdriveSoftClipWaveShaperBypassParameterId, 3), overdriveSoftClipWaveShaperBypassParameterName, false),
              make_unique<AudioParameterFloat> (ParameterID (overdriveGainParameterId, 4), overdriveGainParameterName, gainMinimumValue, gainMaximumValue, gainDefaultValue),
              make_unique<AudioParameterFloat> (ParameterID (powerAmpGainParameterId, 5), powerAmpGainParameterName, gainMinimumValue, gainMaximumValue, gainDefaultValue),
              make_unique<AudioParameterFloat> (ParameterID (powerAmpLowShelfFrequencyParameterId, 6), powerAmpLowShelfFrequencyParamName, frequencyMinimumValue, frequencyMaximumValue, lowShelfFrequencyDefaultValue),
              make_unique<AudioParameterFloat> (ParameterID (powerAmpLowShelfQualityParameterId, 7), powerAmpLowShelfQualityParameterName, qualityMinimumValue, qualityMaximumValue, qualityDefaultValue),
              make_unique<AudioParameterFloat> (ParameterID (powerAmpLowShelfGainParameterId, 8), powerAmpLowShelfGainParameterName, gainMinimumValue, gainMaximumValue, gainDefaultValue),
              make_unique<AudioParameterFloat> (ParameterID (powerAmpPeakFilterFrequencyParameterId, 9), powerAmpPeakFilterFrequencyParameterName, frequencyMinimumValue, frequencyMaximumValue, peakFilterFrequencyDefaultValue),
              make_unique<AudioParameterFloat> (ParameterID (powerAmpPeakFilterQualityParameterId, 10), powerAmpPeakFilterQualityParameterName, qualityMinimumValue, qualityMaximumValue, qualityDefaultValue),
              make_unique<AudioParameterFloat> (ParameterID (powerAmpPeakFilterGainParameterId, 11), powerAmpPeakFilterGainParameterName, 0.01, gainMaximumValue, 0.01),
              make_unique<AudioParameterFloat> (ParameterID (powerAmpHighShelfFrequencyParameterId, 12), powerAmpHighShelfFrequencyParameterName, frequencyMinimumValue, frequencyMaximumValue, highShelfFrequencyDefaultValue),
              make_unique<AudioParameterFloat> (ParameterID (powerAmpHighShelfQualityParameterId, 13), powerAmpHighShelfQualityParameterName, qualityMinimumValue, qualityMaximumValue, qualityDefaultValue),
              make_unique<AudioParameterFloat> (ParameterID (powerAmpHighShelfGainParameterId, 14), powerAmpHighShelfGainParameterName, gainMinimumValue, gainMaximumValue, gainDefaultValue),
              make_unique<AudioParameterFloat> (ParameterID (reverbBlendParameterId, 15), reverbBlendParameterName, blendMinimumValue, blendMaximumValue, reverbBlendDefaultValue),
              make_unique<AudioParameterFloat> (ParameterID (outputGainParameterId, 16), outputGainParameterName, gainMinimumValue, gainMaximumValue, gainDefaultValue),
          })
{
...
void PluginProcessor::loadNamedResourceImpulseResponse (juce::String resourceName, juce::dsp::Convolution& convolutionInstance)
{
    int dataSizeInBytes;
    ...
    if (sourceData != nullptr)
    {
        ...
        if (reader)
        {
            ...
            convolutionInstance.loadImpulseResponse (
                std::move (buffer),
                reader->sampleRate,
